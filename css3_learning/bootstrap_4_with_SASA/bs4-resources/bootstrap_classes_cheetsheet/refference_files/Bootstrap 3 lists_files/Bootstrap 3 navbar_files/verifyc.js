    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'9481fad09ac64693ba29e1a7f765b3e3',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_1505296791493196');
                if (frame) {
...
});var dvObj=$dvbsr;var impId='9481fad09ac64693ba29e1a7f765b3e3';dvObj.pubSub.subscribe('ImpressionServed',impId,'AttributeCollection',function(){
...
try{__tagObject_callback_355105703642({ImpressionID:"9481fad09ac64693ba29e1a7f765b3e3", ServerPublicDns:"tps616.doubleverify.com"});}catch(e){}
try{$dvbsr.pubSub.publish('BeforeDecisionRender', "9481fad09ac64693ba29e1a7f765b3e3");}catch(e){}
try{__verify_callback_355105703642({
ResultID:2,
Passback:"",
AdWidth:160,
AdHeight:600});}catch(e){}
try{$dvbsr.pubSub.publish('AfterDecisionRender', "9481fad09ac64693ba29e1a7f765b3e3");}catch(e){}
