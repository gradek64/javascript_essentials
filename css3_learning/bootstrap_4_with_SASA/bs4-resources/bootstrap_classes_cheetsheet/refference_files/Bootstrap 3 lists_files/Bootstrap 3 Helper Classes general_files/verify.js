    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'3cae5d0747da4e1ea57254ed00e18674',
                comparisonItems:[{name : 'cmp', value : 10992134},{name : 'plmt', value : 11418672}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_131110788300');
                if (frame) {
...
}, 10);var impId = '3cae5d0747da4e1ea57254ed00e18674';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;
...
});var dvObj=$dvbs;var impId='3cae5d0747da4e1ea57254ed00e18674';dvObj.pubSub.subscribe('ImpressionServed',impId,'AttributeCollection',function(){
...
try{__tagObject_callback_131110788300({ImpressionID:"3cae5d0747da4e1ea57254ed00e18674", ServerPublicDns:"tps617.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "3cae5d0747da4e1ea57254ed00e18674");}catch(e){}
try{__verify_callback_131110788300({
ResultID:2,
Passback:"",
AdWidth:160,
AdHeight:600});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "3cae5d0747da4e1ea57254ed00e18674");}catch(e){}
