...
function dv_baseHandler(){function K(e,a){var d=document.createElement("iframe");d.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+L();d.width=0;d.height=0;d.id=a;d.style.display="none";d.src=e;return d}function M(e,a,d){var d=d||150,g=window._dv_win||window;if(g.document&&g.document.body)return a&&a.parentNode?a.parentNode.insertBefore(e,a):g.document.body.insertBefore(e,g.document.body.firstChild),!0;if(0<d)setTimeout(function(){M(e,a,--d)},20);else return!1}function N(e){var a=null;try{if(a=
...
"&num=6"+m+"&srcurlD="+g.depth+"&ssl="+a.ssl+(p?"&dvf=0":"")+(R?"&dvf=1":"")+"&refD="+l+a.tagIntegrityFlag+a.tagHasPassbackFlag+"&htmlmsging="+(x?"1":"0")+(null!=v?"&aadid="+v:"");(g=dv_GetDynamicParams(b).join("&"))&&(a+="&"+g);if(!1===k||s)a=a+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(s?"1":"0"));d="srcurl="+encodeURIComponent(d);if((k=window._dv_win[S("=@42E:@?")][S("2?46DE@C~C:8:?D")])&&0<k.length){s=[];s[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;
for(g=0;g<k.length;g++)s[g+1]=k[g];k=s.reverse().join(",")}else k=null;k&&(d+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(b=dv_GetParam(b,"referrer"))b="&referrer="+b,a.length+b.length<=k&&(a+=b);y.length+i.length+a.length<=k&&(a+=i,d+=y);var E;try{var T=0;y=function(a,b){b&&32>a&&(T=(T|1<<a)>>>0)};var K=function(a,b){return function(){return a.apply(b,arguments)}},O="svg"===document.documentElement.nodeName.toLowerCase(),
...
d=0,g=!1,b;try{for(b=0;10>=b;b++)if(null!=a.parent&&a.parent!=a)if(0<a.parent.location.toString().length)a=a.parent,d++,e=!0;else{e=!1;break}else{0==b&&(e=!0);break}}catch(c){e=!1}0==a.document.referrer.length?e=a.location:e?e=a.location:(e=a.document.referrer,g=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var x;x=!window._dv_win.dv_config||!window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal.pop():
window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1];b=x.script;this.dv_script_obj=x;this.dv_script=b;window._dv_win.dvbsProcessed.push(x);window._dv_win._dvScripts.push(b);var k=b.src;this.dvOther=0;this.dvStep=1;var s;s=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():L():L();var p;x=window.parent.postMessage&&window.JSON;var h=!0,j=!1;if("0"==dv_GetParam(k,
"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)j=!0;if(x&&!1==j)try{p=K(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+s),h=M(p)}catch(y){}var i;p={};try{for(var l=RegExp("[\\?&]([^&]*)=([^&#]*)","gi"),f=l.exec(k);null!=f;)"eparams"!==f[1]&&(p[f[1]]=f[2]),f=l.exec(k);i=p}catch(N){i=p}i.perf=this.perf;i.uid=s;i.script=this.dv_script;i.callbackName="__verify_callback_"+i.uid;i.tagObjectCallbackName="__tagObject_callback_"+i.uid;i.tagAdtag=
...
"cdn.doubleverify.com";d='<html><head><script type="text/javascript">('+function(){try{window.$dv=window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(a){}}.toString()+')();<\/script></head><body><script type="text/javascript">('+(g||"function() {}")+')("'+b.cdnAddress+'");<\/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);<\/script></body></html>';var c=K("about:blank");c.id=c.name;var x=c.id.replace("iframe_","");c.setAttribute&&c.setAttribute("data-dv-frm",
x);M(c,this.dv_script);if(this.dv_script){var k=this.dv_script,s;a:{e=null;try{if(e=c.contentWindow){s=e;break a}}catch(p){}try{if(e=window._dv_win.frames&&window._dv_win.frames[c.name]){s=e;break a}}catch(h){}s=null}k.dvFrmWin=s}var j=N(c);if(j)j.open(),j.write(d);else{try{document.domain=document.domain}catch(y){}var i=encodeURIComponent(d.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));c.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+
i+"');})()"}}catch(l){d=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(d+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(l)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"85"}};
