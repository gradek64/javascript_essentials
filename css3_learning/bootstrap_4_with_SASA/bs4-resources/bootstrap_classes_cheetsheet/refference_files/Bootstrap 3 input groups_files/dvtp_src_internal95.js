...
function Ab(a){try{if(1>=a.depth)return{url:"",depth:""};var c,e=[];e.push({win:window._dv_win.top,depth:0});for(var d,l=1,C=0;0<l&&100>C;){try{if(C++,d=e.shift(),l--,0<d.win.location.toString().length&&d.win!=a)return 0==d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,depth:d.depth-1}}catch(k){}c=d.win.frames.length;for(var f=0;f<c;f++)e.push({win:d.win.frames[f],depth:d.depth+1}),l++}return{url:"",depth:""}}catch(n){return{url:"",depth:""}}}
function W(a){var c=String(),e,d,l;for(e=0;e<a.length;e++)l=a.charAt(e),d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(l),0<=d&&(l="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94)),c+=l;return c}this.createRequest=function(){function a(g,b){var a={};try{if(g.performance&&g.performance.getEntries)for(var e=g.performance.getEntries(),d=0;d<e.length;d++){var f=e[d],h=f.name.match(/.*\/(.+?)\./);
if(h&&h[1]){var l=h[1].replace(/\d+$/,""),D=b[l];if(D){for(var k=0;k<D.stats.length;k++){var i=D.stats[k];a[D.prefix+i.prefix]=Math.round(f[i.name])}delete b[l];if(!c(b))break}}}return a}catch(n){}}function c(b){var a=0,c;for(c in b)b.hasOwnProperty(c)&&++a;return a}window._dv_win.$dv.isEval=1;window._dv_win.$dv.DebugInfo={};var e=!1,d=!1,l,C,k=!1,f=window._dv_win,n=0,Qa=!1,va=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:va}];var O;try{for(O=0;10>=O;O++)if(null!=f.parent&&f.parent!=
f)if(0<f.parent.location.toString().length)f=f.parent,n++,k=!0;else{k=!1;break}else{0==O&&(k=!0);break}}catch(Wb){k=!1}var B;0==f.document.referrer.length?B=f.location:k?B=f.location:(B=f.document.referrer,Qa=!0);var Ua="",wa=null,xa=null;try{window._dv_win.external&&(wa=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,xa=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(Ra){Ua="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||
!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;var X=window._dv_win._dvScriptsInternal.pop(),K=X.script;this.dv_script_obj=X;this.dv_script=K;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=X.loadtime;window._dv_win.dvProcessed.push(X);var b=K.src;this.dv_script_obj.dvSrc=b;var m;if(void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent)m={ID:window._dv_win.$dv.CommonData.BrowserId,
version:window._dv_win.$dv.CommonData.BrowserVersion,ID_UA:window._dv_win.$dv.CommonData.BrowserIdFromUserAgent};else{var Va=dv_GetParam(b,"useragent");m=(new BrowserDetector).getBrowserIdAndVersion(Va?decodeURIComponent(Va):navigator.userAgent);window._dv_win.$dv.CommonData.BrowserId=m.ID;window._dv_win.$dv.CommonData.BrowserVersion=m.version;window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=m.ID_UA}var E,ya=!0,za=window.parent.postMessage&&window.JSON,Wa=!1;if("0"==dv_GetParam(b,"t2te")||window._dv_win.dv_config&&
!0===window._dv_win.dv_config.supressT2T)Wa=!0;if(za&&!1===Wa&&5!=window._dv_win.$dv.CommonData.BrowserId)try{E=Sa(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html"),ya=ua(E)}catch(Xb){}window._dv_win.$dv.DebugInfo.dvp_HTML5=za?"1":"0";var Y=dv_GetParam(b,"region")||"",Z;Z=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream;var Aa;if(Z)Aa="https:";
else{var Xa="http:";"http:"!=window._dv_win.location.protocol&&(Xa="https:");Aa=Xa}var Bb=Aa,Ba;if(Z)Ba="https:";else{var Ya="http:";if("https"==b.match("^https")&&("http"!=window._dv_win.location.toString().match("^http")||"https"==window._dv_win.location.toString().match("^https")))Ya="https:";Ba=Ya}var $=Ba,Za="0";"https:"===$&&(Za="1");try{for(var Cb=f,Ca=f,Da=0;10>Da&&Ca!=window._dv_win.top;)Da++,Ca=Ca.parent;Cb.depth=Da;var $a=Ab(f);dv_aUrlParam="&aUrl="+encodeURIComponent($a.url);dv_aUrlDepth=
"&aUrlD="+$a.depth;dv_referrerDepth=f.depth+n;Qa&&f.depth--}catch(Yb){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=f.depth=""}for(var ab=dv_GetDynamicParams(b,"dvp"),aa=dv_GetDynamicParams(b,"dvpx"),ba=0;ba<aa.length;ba++){var bb=dv_GetKeyValue(aa[ba]);aa[ba]=bb.key+"="+encodeURIComponent(bb.value)}"41"==Y&&(Y=50>100*Math.random()?"41":"8",ab.push("dvp_region="+Y));var cb=ab.join("&"),db=aa.join("&"),Db=window._dv_win.dv_config.tpsAddress||"tps"+Y+".doubleverify.com",P="visit.js";switch(dv_GetParam(b,
"dvapi")){case "1":P="dvvisit.js";break;case "5":P="query.js";break;default:P="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=P;for(var ca="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt dup app dvvidver".split(" "),p=[],v=0;v<ca.length;v++){var Ea=dv_GetParam(b,ca[v])||"";p.push(ca[v]+"="+Ea);""!==Ea&&(window._dv_win.$dv.DebugInfo["dvp_"+ca[v]]=Ea)}for(var Fa="turl icall dv_callback useragent xff timecheck seltag sadv ord litm scrt invs splc adu native gmnpo".split(" "),
...
dv_GetRnd());window._dv_win[lb]=function(b){e=!0;l=b;window._dv_win.$dv&&!0==d&&window._dv_win.$dv.registerEventCall(C,{prplyd:0,dvvidver:b})};p.push("AICB="+lb);var Fb=p.join("&"),mb=window._dv_win.document.createElement("script");mb.src=$+"//cdn.doubleverify.com/dvvid_src.js?"+Fb;window._dv_win.document.body.appendChild(mb)}try{var Q=a(window,{dvtp_src:{prefix:"d",stats:[{name:"fetchStart",prefix:"fs"},{name:"duration",prefix:"dur"}]},dvtp_src_internal:{prefix:"dv",stats:[{name:"duration",prefix:"dur"}]}});
if(!Q||!c(Q))p.push("dvp_noperf=1");else for(var Ia in Q)Q.hasOwnProperty(Ia)&&p.push(Ia+"="+Q[Ia])}catch(bc){}var Gb=p.join("&"),F;var Hb=function(){try{return!!window.sessionStorage}catch(b){return!0}},Ib=function(){try{return!!window.localStorage}catch(b){return!0}},Jb=function(){var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var a=b.getContext("2d");a.textBaseline="top";a.font="14px 'Arial'";a.textBaseline="alphabetic";a.fillStyle="#f60";a.fillRect(0,0,62,20);a.fillStyle=
"#069";a.fillText("!image!",2,15);a.fillStyle="rgba(102, 204, 0, 0.7)";a.fillText("!image!",4,17);return b.toDataURL()}return null};try{var w=[];w.push(["lang",navigator.language||navigator.browserLanguage]);w.push(["tz",(new Date).getTimezoneOffset()]);w.push(["hss",Hb()?"1":"0"]);w.push(["hls",Ib()?"1":"0"]);w.push(["odb",typeof window.openDatabase||""]);w.push(["cpu",navigator.cpuClass||""]);w.push(["pf",navigator.platform||""]);w.push(["dnt",navigator.doNotTrack||""]);w.push(["canv",Jb()]);var s=
w.join("=!!!=");if(null==s||""==s)F="";else{for(var R=function(b){for(var a="",c,e=7;0<=e;e--)c=b>>>4*e&15,a+=c.toString(16);return a},Kb=[1518500249,1859775393,2400959708,3395469782],s=s+String.fromCharCode(128),G=Math.ceil((s.length/4+2)/16),H=Array(G),q=0;q<G;q++){H[q]=Array(16);for(var I=0;16>I;I++)H[q][I]=s.charCodeAt(64*q+4*I)<<24|s.charCodeAt(64*q+4*I+1)<<16|s.charCodeAt(64*q+4*I+2)<<8|s.charCodeAt(64*q+4*I+3)}H[G-1][14]=8*(s.length-1)/Math.pow(2,32);H[G-1][14]=Math.floor(H[G-1][14]);H[G-1][15]=
8*(s.length-1)&4294967295;for(var da=1732584193,ea=4023233417,fa=2562383102,ga=271733878,ha=3285377520,t=Array(80),L,u,z,A,ia,q=0;q<G;q++){for(var h=0;16>h;h++)t[h]=H[q][h];for(h=16;80>h;h++)t[h]=(t[h-3]^t[h-8]^t[h-14]^t[h-16])<<1|(t[h-3]^t[h-8]^t[h-14]^t[h-16])>>>31;L=da;u=ea;z=fa;A=ga;ia=ha;for(h=0;80>h;h++){var nb=Math.floor(h/20),Lb=L<<5|L>>>27,M;c:{switch(nb){case 0:M=u&z^~u&A;break c;case 1:M=u^z^A;break c;case 2:M=u&z^u&A^z&A;break c;case 3:M=u^z^A;break c}M=void 0}var Mb=Lb+M+ia+Kb[nb]+t[h]&
4294967295;ia=A;A=z;z=u<<30|u>>>2;u=L;L=Mb}da=da+L&4294967295;ea=ea+u&4294967295;fa=fa+z&4294967295;ga=ga+A&4294967295;ha=ha+ia&4294967295}F=R(da)+R(ea)+R(fa)+R(ga)+R(ha)}}catch(cc){F=null}F=null!=F?"&aadid="+F:"";var ob=b,Nb=window._dv_win.dv_config.visitJSURL||$+"//"+Db+"/"+P,Ob=Z?"&dvf=0":"",ja;a:{var N=window._dv_win,pb=0;try{for(;10>pb;){if(N.maple&&"object"===typeof N.maple){ja=!0;break a}if(N==N.parent){ja=!1;break a}pb++;N=N.parent}}catch(dc){}ja=!1}var Pb=ja?"&dvf=1":"",b=Nb+"?"+Gb+"&dvtagver=6.1.src&srcurlD="+
f.depth+"&curl="+(null==xa?"":encodeURIComponent(xa))+"&qpgid="+(null==wa?"":wa)+"&ssl="+Za+Ob+Pb+"&refD="+dv_referrerDepth+"&htmlmsging="+(za?"1":"0")+F+Ua;r&&(b+="&ismraid=1");Ga&&(b+="&isovv=1");var Qb=b,i="";try{var x=window._dv_win,i=i+("&chro="+(void 0===x.chrome?"0":"1")),i=i+("&hist="+(x.history?x.history.length:"")),i=i+("&winh="+x.innerHeight),i=i+("&winw="+x.innerWidth),i=i+("&wouh="+x.outerHeight),i=i+("&wouw="+x.outerWidth);x.screen&&(i+="&scah="+x.screen.availHeight,i+="&scaw="+x.screen.availWidth)}catch(ec){}b=
Qb+(i||"");"http:"==b.match("^http:")&&"https"==window._dv_win.location.toString().match("^https")&&(b+="&dvp_diffSSL=1");var qb=K&&K.parentElement&&K.parentElement.tagName&&"HEAD"===K.parentElement.tagName;if(!1===ya||qb)b+="&dvp_isBodyExistOnLoad="+(ya?"1":"0"),b+="&dvp_isOnHead="+(qb?"1":"0");cb&&(b+="&"+cb);db&&(b+="&"+db);var S="srcurl="+encodeURIComponent(B);window._dv_win.$dv.DebugInfo.srcurl=B;var ka;var la=window._dv_win[W("=@42E:@?")][W("2?46DE@C~C:8:?D")];if(la&&0<la.length){var Ja=[];
Ja[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var ma=0;ma<la.length;ma++)Ja[ma+1]=la[ma];ka=Ja.reverse().join(",")}else ka=null;ka&&(S+="&ancChain="+encodeURIComponent(ka));var T=dv_GetParam(b,"uid");null==T?(T=dv_GetRnd(),b+="&uid="+T):(T=dv_GetRnd(),b=b.replace(/([?&]uid=)(?:[^&])*/i,"$1"+T));var na=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(na=2E3);var rb=navigator.userAgent.toLowerCase();if(-1<rb.indexOf("webkit")||-1<rb.indexOf("chrome")){var sb=
"&referrer="+encodeURIComponent(window._dv_win.location);b.length+sb.length<=na&&(b+=sb)}if(navigator&&navigator.userAgent){var tb="&navUa="+encodeURIComponent(navigator.userAgent);b.length+tb.length<=na&&(b+=tb)}dv_aUrlParam.length+dv_aUrlDepth.length+b.length<=na&&(b+=dv_aUrlDepth,S+=dv_aUrlParam);var oa=zb(),b=b+("&vavbkt="+oa.vdcd),b=b+("&lvvn="+oa.vdcv),b=b+("&"+this.getVersionParamName()+"="+this.getVersion()),b=b+("&eparams="+encodeURIComponent(W(S)));""!=oa.err&&(b+="&dvp_idcerr="+encodeURIComponent(oa.err));
m.ID&&(b+="&brid="+m.ID+"&brver="+m.version+"&bridua="+m.ID_UA+"&bds=1",window._dv_win.$dv.DebugInfo.dvp_BRID=m.ID,window._dv_win.$dv.DebugInfo.dvp_BRVR=m.version,window._dv_win.$dv.DebugInfo.dvp_BRIDUA=m.ID_UA);var U;void 0!=window._dv_win.$dv.CommonData.Scenario?U=window._dv_win.$dv.CommonData.Scenario:(U=this.getTrafficScenarioType(window._dv_win),window._dv_win.$dv.CommonData.Scenario=U);b+="&tstype="+U;window._dv_win.$dv.DebugInfo.dvp_TS=U;var pa="";try{window.top==window?pa="1":window.top.location.host==
window.location.host&&(pa="2")}catch(fc){pa="3"}var qa=window._dv_win.document.visibilityState,ub=function(){var a=!1;try{a=r&&"function"===typeof r.getState&&"loading"===r.getState()}catch(c){b+="&dvp_mrgsf=1"}return a},Ka=ub();if("prerender"===qa||Ka)b+="&prndr=1",Ka&&(b+="&dvp_mrprndr=1");var vb="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd()),Rb=this.dv_script;window._dv_win[vb]=function(g,f,j,h){var k=getCurrentTime();
d=!0;C=j;f.$uid=j;var i=Ta(ob);g.tags.add(j,i);i=Ta(b);g.tags[j].set(i);g.tags[j].beginVisitCallbackTS=k;g.tags[j].set({tagElement:Rb,dv_protocol:$,protocol:Bb,uid:j});g.tags[j].ImpressionServedTime=getCurrentTime();g.tags[j].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};try{"undefined"!=typeof h&&null!==h&&(g.tags[j].ServerPublicDns=h),g.tags[j].adServingScenario=pa,g.tags[j].t2tIframeCreationTime=va,g.tags[j].t2tProcessed=!1,g.tags[j].t2tIframeId=E.id,g.tags[j].t2tIframeWindow=
E.contentWindow,$dv.t2tEventDataZombie[E.id]&&(g.tags[j].uniquePageViewId=$dv.t2tEventDataZombie[E.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[E.id],g.tags[j]))}catch(n){}g.messages&&g.messages.startSendingEvents&&g.messages.startSendingEvents(f,j);!0==e&&g.registerEventCall(j,{prplyd:0,dvvidver:l});var B=function(){var a=window._dv_win.document.visibilityState;"prerender"===qa&&("prerender"!==a&&"unloaded"!==a)&&(qa=a,g.tags[j].set({prndr:0}),g.registerEventCall(j,{prndr:0}),
g&&g.pubSub&&g.pubSub.publishHistoryRtnEvent(j),window._dv_win.document.removeEventListener(m,B))},D=function(){"function"===typeof r.removeEventListener&&r.removeEventListener("ready",D);g.tags[j].set({prndr:0});g.registerEventCall(j,{prndr:0});g&&g.pubSub&&g.pubSub.publishHistoryRtnEvent(j)};if("prerender"===qa)if(f=window._dv_win.document.visibilityState,"prerender"!==f&&"unloaded"!==f)g.tags[j].set({prndr:0}),g.registerEventCall(j,{prndr:0}),g&&g.pubSub&&g.pubSub.publishHistoryRtnEvent(j);else{var m;
"undefined"!==typeof window._dv_win.document.hidden?m="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?m="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?m="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(m="webkitvisibilitychange");window._dv_win.document.addEventListener(m,B,!1)}else Ka&&(ub()?"function"===typeof r.addEventListener&&r.addEventListener("ready",D):(g.tags[j].set({prndr:0}),g.registerEventCall(j,{prndr:0}),
g&&g.pubSub&&g.pubSub.publishHistoryRtnEvent(j)));try{var p;a:{var f=window,h={visit:{prefix:"v",stats:[{name:"duration",prefix:"dur"}]}},q;if(f.frames)for(k=0;k<f.frames.length;k++)if((q=a(f.frames[k],h))&&c(q)){p=q;break a}p=void 0}p&&$dv.registerEventCall(j,p)}catch(s){}};var ra;try{var La=0,sa=function(a,b){b&&32>a&&(La=(La|1<<a)>>>0)},Sb=function(a,b){return function(){return a.apply(b,arguments)}},Tb="svg"===document.documentElement.nodeName.toLowerCase(),wb=function(){return"function"!==typeof document.createElement?
document.createElement(arguments[0]):Tb?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},Ub=["Moz","O","ms","Webkit"],Vb=["moz","o","ms","webkit"],y={style:wb("modernizr").style},Ma=function(a,b,c,e,f){var d=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+Ub.join(d+" ")+d).split(" ");if("string"===typeof b||"undefined"===typeof b){a:{c=h;a=function(){k&&(delete y.style,delete y.modElem)};f="undefined"===typeof f?!1:f;
if("undefined"!==typeof e&&(d=nativeTestProps(c,e),"undefined"!==typeof d)){b=d;break a}for(var k,i,l,d=["modernizr","tspan","samp"];!y.style&&d.length;)k=!0,y.modElem=wb(d.shift()),y.style=y.modElem.style;h=c.length;for(d=0;d<h;d++)if(i=c[d],l=y.style[i],~(""+i).indexOf("-")&&(i=cssToDOM(i)),void 0!==y.style[i])if(!f&&"undefined"!==typeof e){try{y.style[i]=e}catch(m){}if(y.style[i]!=l){a();b="pfx"==b?i:!0;break a}}else{a();b="pfx"==b?i:!0;break a}a();b=!1}return b}h=(a+" "+Vb.join(d+" ")+d).split(" ");
for(i in h)if(h[i]in b){if(!1===c)return h[i];e=b[h[i]];return"function"===typeof e?Sb(e,c||b):e}return!1};sa(0,!0);var Na;var J="requestFileSystem",xb=window;0===J.indexOf("@")?Na=atRule(J):(-1!=J.indexOf("-")&&(J=cssToDOM(J)),Na=xb?Ma(J,xb,void 0):Ma(J,"pfx"));sa(1,!!Na);sa(2,window.CSS?"function"==typeof window.CSS.escape:!1);sa(3,Ma("shapeOutside","content-box",!0));ra=La}catch(gc){ra=0}ra&&(b+="&m1="+ra);for(var yb,ta="auctionid vermemid source buymemid anadvid ioid cpgid cpid sellerid pubid advcode iocode cpgcode cpcode pubcode prcpaid auip auua".split(" "),
Oa=[],V=0;V<ta.length;V++){var Pa=dv_GetParam(ob,ta[V]);null!=Pa&&(Oa.push("dvp_"+ta[V]+"="+Pa),Oa.push(ta[V]+"="+Pa))}(yb=Oa.join("&"))&&(b+="&"+yb);return b+"&jsCallback="+vb};this.sendRequest=function(a){window._dv_win.t2tTimestampData.push({beforeVisitCall:getCurrentTime()});var c=this.dv_script_obj&&this.dv_script_obj.injScripts,e=this.dv_script_obj&&this.dv_script_obj.srcLocation,d=this.dv_script_obj&&this.dv_script_obj.dvSrc,l=this.getVersionParamName(),C=this.getVersion(),k=window._dv_win.dv_config=
window._dv_win.dv_config||{};k.tpsErrAddress=k.tpsAddress||"tps30.doubleverify.com";k.cdnAddress=k.cdnAddress||"cdn.doubleverify.com";var f={};f[l]=C;f.dvp_jsErrUrl=a;f.dvp_jsErrMsg=encodeURIComponent("Error loading visit.js");l=dv_CreateAndGetErrorImp(k.tpsErrAddress+"/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_isLostImp=1",f);c='<html><head><script type="text/javascript">('+function(a){try{window.dvSrc=a,window.$dv=window.$dv||parent.$dv,window.$dv.dvObjType="dv",window.$frmId=Math.random().toString(36)+
Math.random().toString(36)}catch(c){}}.toString()+')("'+d+'");<\/script></head><body><script type="text/javascript">('+(c||"function() {}")+')("'+e+'");<\/script><script type="text/javascript" id="TPSCall" src="'+a+'"><\/script><script type="text/javascript">('+function(a){var c=document.getElementById("TPSCall");try{c.onerror=function(){try{(new Image).src=a}catch(c){}}}catch(d){}c&&c.readyState?(c.onreadystatechange=function(){"complete"==c.readyState&&document.close()},"complete"==c.readyState&&
document.close()):document.close()}.toString()+')("'+l+'");<\/script></body></html>';a=Sa("about:blank");e=a.id.replace("iframe_","");a.setAttribute&&a.setAttribute("data-dv-frm",e);ua(a,this.dv_script);if(this.dv_script){this.dv_script.id="script_"+e;var e=this.dv_script,n;a:{d=null;try{if(d=a.contentWindow){n=d;break a}}catch(W){}try{if(d=window._dv_win.frames&&window._dv_win.frames[a.name]){n=d;break a}}catch(va){}n=null}e.dvFrmWin=n}if(n=Ra(a))n.open(),n.write(c);else{try{document.domain=document.domain}catch(O){}n=
encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));a.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+n+"');})()"}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){window._dv_win._dvScriptsInternal.unshift(this.dv_script_obj);var a=window._dv_win.dvProcessed,c=this.dv_script_obj;null!=a&&(void 0!=a&&c)&&(c=a.indexOf(c),-1!=c&&a.splice(c,1));return window._dv_win.$dv.DebugInfo};this.getTrafficScenarioType=
function(a){var a=a||window,c=a._dv_win.$dv.Enums.TrafficScenario;try{if(a.top==a)return c.OnPage;for(var e=0;a.parent!=a&&1E3>e;){if(a.parent.document.domain!=a.document.domain)return c.CrossDomain;a=a.parent;e++}return c.SameDomain}catch(d){}return c.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"137"}};
